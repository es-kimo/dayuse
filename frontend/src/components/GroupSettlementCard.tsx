  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        {isHost && (
          <button
            ...
            className="px-2.5 py-1 text-[11px] font-semibold text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg flex items-center gap-1 transition"
          >
            <span>정산 관리</span>
      ...
      {loading ? (
        ...
        <div className="bg-amber-50/70 border border-amber-200/70 rounded-xl p-3 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <AlertCircle className="w-4 h-4 text-amber-600 shrink-0" />
            <div className="text-[11px] text-amber-800">
              {isHost
                ? '모임원들이 입금할 모임 계좌를 먼저 등록해 주세요.'
                : '모임장이 아직 정산 계좌를 등록하지 않았습니다.'}
            </div>
          </div>
          {isHost && (
            <button
              onClick={handleOpenEditAccount}
              className="px-2.5 py-1 bg-amber-600 hover:bg-amber-700 text-white text-[11px] font-semibold rounded-lg shrink-0 transition"
            >
              계좌 등록
            </button>
          )}
            ...
            <form onSubmit={handleSaveAccount} className="space-y-3">
              ...
              <div className="pt-2 flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg flex items-center justify-center gap-1 transition"
                >
